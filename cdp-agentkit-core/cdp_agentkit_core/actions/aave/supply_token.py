...
from cdp_agentkit_core.actions.aave.constants import (
    AAVE_FACTORY_ABI,
    AAVE_GATEWAY_ABI,
    get_factory_address,
)
...
class AaveSupplyAction(CdpAction):
    """Aave supply action."""

    name: str = "aave_supply"
    description: str = AAVE_SUPPLY_PROMPT
    args_schema: type[BaseModel] | None = AaveSupplyInput
    func: Callable[..., str] = aave_supply_token
